...
var marked0$0 = [reduceTest, test, parseAsNode, clusterMachineGenerator, generator2, generator3].map(regeneratorRuntime.mark);
...
function reduceTest() {
  return regeneratorRuntime.wrap(function reduceTest$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 9:
        return context$1$0.abrupt('return', regeneratorRuntime.mark(function callee$1$0() {
          return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
              case 0:
                context$2$0.next = 2;
              ...
              case 4:
                return context$2$0.abrupt('return', regeneratorRuntime.mark(function callee$2$0() {
                  return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
                    while (1) switch (context$3$0.prev = context$3$0.next) {
                      case 0:
...
var addition = function addition() {
  return makeNode('+', regeneratorRuntime.mark(function callee$1$0() {
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          context$2$0.next = 2;
        ...
        case 2:
          return context$2$0.abrupt('return', makeNode('*', regeneratorRuntime.mark(function callee$2$0() {
            return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
              while (1) switch (context$3$0.prev = context$3$0.next) {
                case 0:
                  context$3$0.next = 2;
...
function parseAsNode(obj, value) {
  ...
  return regeneratorRuntime.wrap(function parseAsNode$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        childrenFunction = function childrenFunction(obj) {
          var _i, keys, _ret;

          return regeneratorRuntime.wrap(function childrenFunction$(context$2$0) {
            var _this = this;
            ...
            while (1) switch (context$2$0.prev = context$2$0.next) {
              ...
              case 11:
                ...
                return context$2$0.delegateYield(regeneratorRuntime.mark(function callee$2$0() {
                  var _i2, _key, _childValue, key, childValue;
                  ...
                  return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
                    while (1) switch (context$3$0.prev = context$3$0.next) {
                      ...
                      case 4:
                        if (!(_i2 < keys.length - 1)) {
                          context$3$0.next = 12;
                          break;
                        }

                        _key = keys[_i2];
                        _childValue = obj[_key];
                        context$3$0.next = 9;
                        return makeNode(_key, (function (childValue) {
                          return function () {
        ...
        marked1$0 = [childrenFunction].map(regeneratorRuntime.mark);
...
function clusterMachineGenerator(machineCount, prefix) {
  ...
  return regeneratorRuntime.wrap(function clusterMachineGenerator$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
...
function generator2() {
  ...
  return regeneratorRuntime.wrap(function generator2$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
...
function generator3() {
  var loop, queue, generatorResult, machineGenerator, machineResult;
  return regeneratorRuntime.wrap(function generator3$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        loop = interleave(toGenerator(q)), queue = loop.next().value;
