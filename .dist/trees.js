...
var marked0$0 = [preorder, inorder, postorder, breadthFirst, makeNode, allBinaryTrees, allBinaryTrees, allTrees].map(regeneratorRuntime.mark);
...
function preorder(node) {
  ...
  return regeneratorRuntime.wrap(function preorder$(context$1$0) {
...
function inorder(node) {
  ...
  return regeneratorRuntime.wrap(function inorder$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        if (!node) {
...
function postorder(node) {
  ...
  return regeneratorRuntime.wrap(function postorder$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        if (!node) {
...
function breadthFirst(node, indent) {
  ...
  return regeneratorRuntime.wrap(function breadthFirst$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        indent = indent || '';
        if (!node) {
...
function makeNode(value, children) {
  var result;
  return regeneratorRuntime.wrap(function makeNode$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        if (!children) {
          context$1$0.next = 17;
...
function allBinaryTrees(size, valueGenerator) {
  ...
  return regeneratorRuntime.wrap(function allBinaryTrees$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        constructTree = function constructTree(leftSize, rightSize, valueGenerator, seed) {
          var value;
          return regeneratorRuntime.wrap(function constructTree$(context$2$0) {
        ...
        marked1$0 = [constructTree].map(regeneratorRuntime.mark);
...
function allBinaryTrees(size, valueGenerator, seed) {
  var nodeValue, i, _left, j, right, _leftResult, createLeft, rightResult, createRight, left, leftResult;
  ...
  return regeneratorRuntime.wrap(function allBinaryTrees$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 7:
        ...
        _left = allBinaryTrees(i, valueGenerator, nodeValue + 1);
      ...
      case 9:
        ...
        j = size - 1 - i, right = allBinaryTrees(j, valueGenerator, nodeValue + 1), _leftResult = _left.next(), createLeft = _leftResult.value;
...
function allTrees(size, maxChildren, parent, nodeValueGenerator) {
  var i, _left2, leftResult, _j, right, rightResult, children, childValue, left, j;

  return regeneratorRuntime.wrap(function allTrees$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
      ...
      case 10:
        ...
        console.log('i', i);
        _left2 = allBinaryTrees(i, nodeValueGenerator);

        console.log('left', _left2);
      ...
      case 14:
        ...
        leftResult = _left2.next(), _j = size - 1 - i, right = allBinaryTrees(_j, nodeValueGenerator);
