...
var preorder = _regeneratorRuntime.mark(
...
var inorder = _regeneratorRuntime.mark(
...
var postorder = _regeneratorRuntime.mark(
...
var breadthFirst = _regeneratorRuntime.mark(
...
var makeNode = _regeneratorRuntime.mark(function makeNode(value, children) {
  var result;
...
var allBinaryTrees = _regeneratorRuntime.mark(function allBinaryTrees(size, valueGenerator) {
  var constructTree = _regeneratorRuntime.mark(function constructTree(leftSize, rightSize, valueGenerator, seed) {
    var value;
...
var allBinaryTrees = _regeneratorRuntime.mark(
...
var allTrees = _regeneratorRuntime.mark(function allTrees(size, maxChildren, parent, nodeValueGenerator) {
