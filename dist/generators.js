...
Object.defineProperties(exports, {
  ...
  modifiableStack: {get: function() {
      return modifiableStack;
    }},
  modifiableQueue: {get: function() {
  ...
  repeatG: {get: function() {
      return repeatG;
    }},
  integers: {get: function() {
      return integers;
    }},
  take: {get: function() {
      return take;
...
var __moduleName = "dist/generators";
var TERMINAL = Symbol();
;
function* loop(g) {
  var q = [],
...
function* transform(generator, fn) {
  while (true) {
    ...
    if (done)
      return value == TERMINAL ? value : fn(value);
    else
      yield fn(value);
  }
}
