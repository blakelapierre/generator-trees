...
"use strict";
var __moduleName = "dist/tests/index";
...
testTree('tree', tree);
var tree2 = {'root': [{'+': [1, 2, {'*': [3, 4]}]}, {'middle': {'goes': {'deep': ['into', 'the', {'tree': true}]}}}, {'names': [{
      'five': 5,
      'six': 6
    }]}]};
testTree('tree2', tree2);
var tree3 = {'root': [{'+': [1, 2, {'*': [3, 4]}]}, {'middle': {'goes': {'deep': ['into', 'the', {'tree': true}]}}}, {'names': [{'five': 5}, {'six': 6}]}]};
testTree('tree3', tree3);
var tree4 = {'root': [{'+': [1, 2, {'*': [3, 4]}]}, {'middle': {'goes': {'deep': ['into', 'the', {'tree': true}]}}}, {'names': [{'five': 5}, {'six': 6}]}]};
...
function* parseAsNode(obj, value) {
  value = value || '@@root';
  var generator = makeNode(value, (function() {
  ...
  function* childrenFunction(obj) {
    if (obj.length) {
      ...
      for (var i = 0; i < keys.length - 1; i++) {
        ...
        yield makeNode(key, ((function(childValue) {
          return (function() {
